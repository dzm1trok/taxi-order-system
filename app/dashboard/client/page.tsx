      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">На данный момент</p>
            <div className="mt-4">
              <Link href="/dashboard/client/new-order">
                <Button variant="outline" size="sm">
                  Заказать такси
            ...
            <div className="space-y-4">
              <div className="border-b pb-2">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-medium">Поездка 01.06.2025</p>
                  <div className="flex items-center">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <svg
                        key={star}
              ...
              <div className="border-b pb-2">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-medium">Поездка 30.05.2025</p>
                  <div className="flex items-center">
                  {[1, 2, 3, 4, 5].map((star) => (
                      <svg
                        key={star}
                ...
                <p className="text-xs text-muted-foreground mt-1">Вежлевое и приятное общение.</p>
              </div>
            </div>
          </CardContent>
        </Card>
